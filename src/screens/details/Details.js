...
export default function Details() {
                ...
                artists: [
                    {
                        ...
                        "role_type": "ACTOR",
                        "profile_description": "Marlon Brando Jr. was an American actor and film director. He is credited with bringing realism to film acting and helping to popularize the Stanislavski system of acting having studied with Stella Adler in the 1940s. Regarded for his cultural influence on 20th century film, Brando's Academy Award-winning performances include that of Terry Malloy in On the Waterfront (1954) and Don Vito Corleone in The Godfather (1972). Brando was an activist for many causes, notably the civil rights movement and various Native American movements.",
                        "profile_url": "https://cdn.britannica.com/97/90697-050-1AE6A31D/Marlon-Brando-A-Streetcar-Named-Desire.jpg",
                        "wiki_url": "https://en.wikipedia.org/wiki/Marlon_Brando"
                    },
                    {
                        "id": "A2",
        ...
        return <div>
            ...
            <div style={{display:'flex'}}>
                <div style={{width:'20%'}}>
                 <img src={movieData[0].poster_url} alt={moviesData[0].id} style={{marginLeft:"16px" , width:"220px"}}></img>  
                </div>
                <div style={{width:'60%'}}>
                  <h2>{movieData[0].title}</h2>
                  <b>Genre:</b>
                  {movieData[0].genres.map((item)=><span> {item} </span>)}<br></br>
                  <b>Duration:</b><span> {movieData[0].duration} min</span><br></br>
                  <b>Release Date:</b><span> {new Date(movieData[0].release_date).toLocaleDateString(undefined, options)}</span><br></br>
                  <b>Rating:</b><span> {movieData[0].critics_rating}</span><br></br>
                  <b>Plot:</b><span> {movieData[0].storyline}</span><br></br>
                  <b>Trailer:</b>
                  <iframe title="trailer" src={movieData[0].trailer_url} style={{width:"95%" , height:"90%"}}></iframe>
                </div>
                <div style={{width:'20%'}}>
